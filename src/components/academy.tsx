...
export const Academy = ({onlyCourses = false}: {onlyCourses?: boolean}) => {
    return (
        <div className="lg:px-14 px-4 lg:py-12 py-6">
            ...
            {onlyCourses && <span className="font-bold text-2xl lg:text-5xl">Available Courses</span>}
            {!onlyCourses && <div className="mt-6 bg-[#D1DAEC] rounded-[16px] lg:h-[484px] px-2 lg:px-8 py-12 flex gap-8 lg:flex-row flex-col">
            ...
            {onlyCourses && <div className="mt-6 bg-[#D1DAEC] rounded-[16px] lg:h-[484px] px-2 lg:px-8 py-12 flex gap-8 lg:flex-row flex-col">
                <Link href={ '/academy/1' } className="card lg:w-[370px] h-[390px] rounded-[32px] p-6 bg-[#FBFCFC]">
                    <div className="top flex flex-col gap-1 mb-4">
                        <div className="img relative rounded-[16px] bg-[url('/images/academy1.svg')] lg:w-[322px] h-[207px] bg-cover bg-center">
                            <div className="absolute bottom-2 right-2 py-1 pl-1 pr-2 flex gap-1 bg-[#FBFCFC] rounded-3xl">
                                <Clock className="w-[13.33px] h-[13.33px]" />
                ...
                <Link href={'/academy/2'} className="card lg:w-[370px] h-[390px] rounded-[32px] p-6 bg-[#FBFCFC]">
                    <div className="top flex flex-col gap-1 mb-4">
                        <div className="img relative rounded-[16px] bg-[url('/images/academy2.svg')] lg:w-[322px] h-[207px] bg-cover bg-center">
                            <div className="absolute bottom-2 right-2 py-1 pl-1 pr-2 flex gap-1 bg-[#FBFCFC] rounded-3xl">
                                <Clock className="w-[13.33px] h-[13.33px]" />
