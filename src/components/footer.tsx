...
const navigation = [
  ...
  { title: "Blog", href: "/growth-hub" },
  { title: "About our Growth Hub", href: "/growth-hub" },
...
export default function Footer() {
  ...
  return (
    <footer className="w-full flex flex-col gap-10 bg-[#1746A2] text-white px-4 lg:px-14 py-12 lg:mt-16">
      <div className="scale bg-[#020609] rounded-[32px] w-full flex flex-wrap items-center justify-between px-8 py-4 gap-5 lg:px-16 lg:py-8 lg:mb-16">
        <span className="font-semibold text-2xl lg:text-6xl leading-[130%] lg:w-[750px]">
        ...
        <div className="flex items-center flex-col lg:flex-row justify-between gap-10 lg:gap-[100px]">
          ...
          <div className="flex flex-col gap-3.5 lg:gap-[30px] lg:w-[800px]">
            ...
            <p className="text-[#DFDFDF] text-sm leading-[24px] text-center md:text-left">
              We provide end-to-end business growth services that tackle every
              scaling challenge African businesses face, from AI-powered
              strategy development and expert talent matching to performance
              analytics and execution frameworks, our platform delivers the
              complete infrastructure to accelerate sustainable business growth.
            </p>
            <div className="flex items-center justify-center md:items-start md:justify-start gap-3">
              ...
              <div onClick={() => router.push("https://www.linkedin.com/company/growthpadi/")} className="bg-white w-[34px] h-[34px] rounded-full flex items-center justify-center">
                <Linkedin className="w-4 h-4 text-[#1746A2] hover:text-[#7392ee] cursor-pointer" />
              </div>
              <div onClick={() => router.push("https://www.instagram.com/scalepadi?igsh=Y2lheGZvMjdoYTlu")} className="bg-white w-[34px] h-[34px] rounded-full flex items-center justify-center">
          ...
          <div className="w-full flex flex-col md:flex-row gap-11 lg:gap-[95px]">
            ...
            <div className="w-full flex flex-col items-center justify-center md:items-start md:justify-start">
              <h4 className="font-semibold text-lg mb-5 lg:mb-10">
                Navigation
              </h4>
