...
const ArticlesSection = () => {
    ...
    //     const activeCategory = tabs[active]
    ...
    return (
        <div className="bg-[#F7F7F7] py-5 lg:py-8">
            <div className="tabs py-2 border-b px-4 lg:px-[119px] border-[#EFF2F3] mb-5">
                ...
                {tabs.map((tab, index) => (
                    <div
                        ...
                        className={clsx(
                            ...
                            active === index ? "text-[#1A1A1A] font-medium" : "text-[#878A93] hover:text-[#1A1A1A]"
                        )}
                    >
                        {tab}
                        {active === index && (
            ...
            <div className="px-4 lg:px-[119px] flex flex-col lg:flex-row items-center justify-between gap-6 my-4 lg:my-10">
                {/* Text */}
                <div className="text-center lg:text-left">
                    <span className="text-2xl md:text-3xl font-semibold text-[#2F2F2F] lg:leading-[46px]">
                        Join our news letter and get the <br className="hidden md:block" />
                ...
                {/* Input and Button */}
                <form className="w-full lg:w-[545px] flex items-center border lg:h-[68px] border-[#D1DAEC] rounded-full overflow-hidden px-2 py-1 bg-[#F7F7F7]">
                    <input
                        type="email"
