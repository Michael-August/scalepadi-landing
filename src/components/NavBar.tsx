...
export default function Navbar() {
  ...
  return (
    <nav className="w-full z-50 sticky top-0 bg-white border-b border-[#E5E8EB] px-4 py-3 lg:px-14 flex items-center justify-between">
      ...
      <div className="hidden lg:flex items-center space-x-8">
        <Link
          href="/"
          className="text-gray-700 hover:text-[#1746A2] transition-colors"
        >
          Home
        </Link>
        {pathname === "/" ? (
        ...
        <div className="flex items-center space-x-4">
          <Button
            onClick={() => router.push("https://forms.gle/kXgoWnLTruDVxw6z9")}
            variant="outline"
            className="border-[#1746A2] text-[#1746A2] hover:bg-[#1746A2] hover:text-white bg-transparent"
          >
            For Experts
          </Button>
          <Button onClick={() => router.push("https://forms.gle/57L2a7cFkrnTQ7Zx7")} className="bg-[#1746A2] hover:bg-[#1746A2] text-white">
            For Business
          </Button>
        </div>
      </div>
      ...
      <div className="flex lg:hidden items-center space-x-4">
        <Button
          onClick={() => router.push("https://forms.gle/57L2a7cFkrnTQ7Zx7")}
          variant="outline"
        ...
        >
          ...
          <nav className="flex flex-col space-y-4">
            <Link
              ...
              href="/"
              className="text-gray-700 hover:text-[#1746A2]"
            >
              Home
            </Link>
            {pathname === "/" ? (
              ...
              {showDropdown && (
                <div className="absolute top-full mt-2 w-40 bg-white border rounded-md shadow-lg z-50">
                  <Link
                    onClick={() => setIsOpen(false)}
                    href="/academy"
                    className="block px-4 rounded-md py-2 text-left hover:bg-[#F4F8FF]"
                  >
                    Academy
                  </Link>
                  <Link
                    onClick={() => setIsOpen(false)}
                    href="/growth-hub"
                    className="block px-4 py-2 rounded-md text-left hover:bg-[#F4F8FF]"
                  >
                    Growth Hub
                  </Link>
                </div>
